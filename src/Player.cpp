...
Player::Player()
{
	...
	quackComp.Init("Res/quack.wav");
	spriteComp.Init("Res/JanitorDuck.png", 0.5f);
	collisionComp.CircleInit(sf::Color::Cyan, duckyRadius);
...
{
	quackComp.SetProperties(quackVolume);
}
